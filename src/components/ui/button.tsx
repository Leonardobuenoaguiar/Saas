...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer select-none",
  {
    variants: {
      variant: {
        default:
          "bg-gray-900 text-white hover:bg-gray-800 shadow-sm focus-visible:ring-gray-900",
        destructive:
          "bg-red-500 text-white hover:bg-red-600 shadow-sm focus-visible:ring-red-500",
        outline:
          "border border-gray-200 bg-white text-gray-900 hover:bg-gray-50 hover:border-gray-300 shadow-sm focus-visible:ring-gray-900",
        secondary:
        ...
        primary:
          "bg-violet-600 text-white hover:bg-violet-700 shadow-sm focus-visible:ring-violet-500",
        success:
